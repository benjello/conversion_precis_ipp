...
\usepackage{arcs}                       % Pour réaliser le logo TAXIPP/PENSIPP
\usepackage{slashbox}                   % Pour réaliser le logo TAXIPP/PENSIPP
\usepackage{MnSymbol}                   % Pour réaliser le logo TAXIPP/PENSIPP
\PassOptionsToPackage{usenames,dvipsnames,svgnames}{xcolor} % Pour réaliser le logo TAXIPP/PENSIPP
\usepackage{xcolor}                     % Pour réaliser le logo TAXIPP/PENSIPP
\usepackage[pdftitle={Réformes strucurelles du système de retraite français},
